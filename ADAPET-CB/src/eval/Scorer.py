...
class Scorer(object):
    ...
    def _compute_f1(self):
        ...
        if self.is_record:
            ...
            # print('f1_true_lbl[:50] ', f1_true_lbl[:50])
            # print('f1_pred_lbl[:50] ', f1_pred_lbl[:50])
            f1 = f1_score(f1_true_lbl, f1_pred_lbl, average='micro',labels=[1, 2, 3, 4]) # 0 is false class
            avg_f1 = f1
            # avg_f1 = np.mean(f1)
