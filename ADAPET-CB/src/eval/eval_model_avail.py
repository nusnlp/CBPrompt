...
def test_eval(config, model, batcher, dummy_test_size, repeat):
    '''
    ...
    test_writer = Writer(os.path.join(config.exp_dir, "test_dummy_{}_{}.json".format(dummy_test_size, repeat)), dataset_reader)
